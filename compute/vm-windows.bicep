...
param osImageSKU string = '2019-datacenter-gensecond'
param osImagePublisher string = 'MicrosoftWindowsServer'
param osSqlImagePublisher string = 'MicrosoftSQLServer'
...
@description('Windows Server SQL Offer')
@allowed([
  'SQL2019-WS2019'
  'SQL2017-WS2019'
  'SQL2019-WS2022'
...
param sqlImageOffer string = 'SQL2019-WS2022'
...
param leastPrivilegeMode string = 'NotSet'
/*
@allowed([
  'Developer'
  'Enterprise'
...
resource vm 'Microsoft.Compute/virtualMachines@2023-03-01' = {
  ...
  properties: {
    ...
    storageProfile: {
      imageReference: {
        publisher: isSqlVm ? osSqlImagePublisher : osImagePublisher
        offer: isSqlVm ? sqlImageOffer : osImageOffer
        sku: isSqlVm ? sqlImageSku : osImageSKU
...
resource sqlVm 'Microsoft.SqlVirtualMachine/sqlVirtualMachines@2023-01-01-preview' = if (isSqlVm) {
  name: vmName
  location: location
  properties: {
